...
export default function GlobalSearchPage() {
  ...
  const results = useMemo(() => ({
    ...
    organizers: normalizedQuery ? searchableOrganizers.filter(organizer => containsQuery(normalizedQuery, organizer.publicName, organizer.city, organizer.country, organizer.shortDescription, organizer.longDescription, ...getEntityRegionIds(organizer).map(getRegionName))).slice(0, 8) : [],
