...
const checks = [
  ...
  {
    file: 'app/components/features/account/PaymentSuccessClient.tsx',
    required: [
      'GROWTH_EVENT_NAMES.purchaseConfirmed',
      'lib_growth_purchase_',
  ...
  {
    file: 'app/(public)/blog/benin/page.tsx',
    required: [
      'data-growth-event="cta_click"',
      'data-growth-surface="blog_benin_hero"',
      'data-growth-surface="blog_benin_cluster"',
      'data-growth-surface="blog_benin_city_guides"',
      'data-growth-surface="blog_benin_strategic_guides"',
      'data-growth-surface="blog_benin_supply"',
      'data-growth-target="events"',
      'data-growth-target="search"',
      'data-growth-target={cta.target}',
    ],
  },
  {
  ...
  },
  {
    ...
    required: [
      'data-growth-event="cta_click"',
      'data-growth-surface="public_search_results"',
      'search_result_event',
      'search_result_organizer',
      'search_result_provider',
      'search_all_events',
      'search_all_organizers',
