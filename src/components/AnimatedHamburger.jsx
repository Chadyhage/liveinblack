// Bouton hamburger animé : barres qui s'écartent au survol, et qui se
// transforment en croix quand `active` (menu ouvert) — piloté
...
export default function AnimatedHamburger({ active, onClick, size = 56 }) {
  return (
    <button
      ...
      className="group relative flex items-center justify-center rounded-[18px] border border-zinc-800/50 bg-[#121216] text-zinc-400 transition-all duration-300 hover:border-white/20 hover:bg-[#16161c] active:scale-95"
      style={{
    ...
    >
      ...
      >
        <span
          className="h-[2px] w-full rounded-full transition-all duration-300 group-hover:bg-white"
          style={{
            background: active ? '#ffffff' : '#8b8b94',
