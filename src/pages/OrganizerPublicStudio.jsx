...
export default function OrganizerPublicStudio() {
  ...
  return <Layout><div className="org-studio">
    <style>{`
      ...
      .os-stats{display:grid;grid-template-columns:repeat(3,1fr);border:1px solid rgba(255,255,255,.08);border-radius:16px;background:#0e0f16;box-shadow:0 8px 24px rgba(0,0,0,.35);overflow:hidden;margin-bottom:16px}.os-stat{padding:18px;border-right:1px solid rgba(255,255,255,.08)}.os-stat:last-child{border:0}.os-stat b{display:block;font:28px ${DISPLAY}}.os-stat span{font:600 11px ${UI};color:rgba(255,255,255,.5);letter-spacing:.06em;text-transform:uppercase}
