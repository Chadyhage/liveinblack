...
export default function PublicOrganizerPage() {
  ...
  const page = <div className="organizer-public">
    <style>{`
      ...
      .op-tags{display:flex;flex-wrap:wrap;gap:7px;margin-top:18px}.op-tag{padding:4px 10px;border-radius:8px;background:rgba(78,232,200,.12);border:1px solid rgba(78,232,200,.35);color:${C.teal};font:700 11px ${UI};letter-spacing:.04em;text-transform:uppercase}
