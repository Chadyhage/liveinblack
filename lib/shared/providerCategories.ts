...
export const PROVIDER_CATEGORIES: ProviderCategory[] = [
  { id: 'artiste', label: 'Artistes, DJ & animation', singular: 'Artiste / DJ / animation', icon: 'mic', color: '#c8a96e', description: 'DJ, musicien, danseur, MC, performeur, animation…' },
  { id: 'salle', label: 'Salles & lieux', singular: 'Salle / lieu', icon: 'building', color: '#c8a96e', description: 'Club, rooftop, loft, domaine, espace de réception…' },
  { id: 'materiel', label: 'Technique & matériel', singular: 'Technique / matériel', icon: 'speaker', color: '#c8a96e', description: 'Son, lumière, scène, vidéo, mobilier, structures…' },
  ...
  { id: 'decoration', label: 'Décoration & scénographie', singular: 'Décoration / scénographie', icon: 'sparkle', color: '#e8d49e', description: 'Décoration, fleurs, scénographie, design d’espace…' },
  ...
  { id: 'staff', label: 'Équipe & renfort événementiel', singular: 'Équipe événementielle', icon: 'users', color: '#d7bd82', description: 'Serveurs, hôtes, techniciens, régisseurs, personnel…' },
  { id: 'communication', label: 'Communication & création', singular: 'Communication / création', icon: 'megaphone', color: '#e8d49e', description: 'Graphisme, réseaux sociaux, promotion, impression…' },
  { id: 'bien_etre', label: 'Beauté & bien-être', singular: 'Beauté / bien-être', icon: 'heart', color: '#d7bd82', description: 'Maquillage, coiffure, stylisme et préparation…' },
