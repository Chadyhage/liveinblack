...
export const DISCS: Disc[] = [
  ...
  { id: 'techno', name: 'Techno', bpm: 130, color: '#f7f7f8', desc: 'Sombre & roulant' },
  { id: 'lofi', name: 'Lo-Fi', bpm: 84, color: '#b8b8bf', desc: 'Jazzy, posé' },
  { id: 'nuit', name: 'Nuit', bpm: 68, color: '#77777f', desc: 'Nappes ambient' },
]
