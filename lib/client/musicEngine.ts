...
export const DISCS: Disc[] = [
  { id: 'house', name: 'House', bpm: 124, color: '#c8a96e', desc: '4/4 chaud, claps' },
  { id: 'afro', name: 'Afro', bpm: 112, color: '#c8a96e', desc: 'Percu & marimba' },
  { id: 'techno', name: 'Techno', bpm: 130, color: '#c8a96e', desc: 'Sombre & roulant' },
