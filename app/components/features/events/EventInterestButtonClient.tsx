...
export default function EventInterestButtonClient({
  ...
  const style: React.CSSProperties = {
    ...
    borderRadius: 999,
    border: interested ? `1px solid rgba(184, 243, 74,${floating ? 0.42 : 0.38})` : 'none',
    background: interested ? `rgba(184, 243, 74,${floating ? 0.16 : 0.12})` : floating ? 'rgba(0,0,0,0.55)' : 'rgba(255,255,255,0.07)',
