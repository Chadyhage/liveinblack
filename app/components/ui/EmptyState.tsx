...
export default function EmptyState({ title, description, action }: { title: string; description?: string; action?: ReactNode }) {
  return (
    <div style={{ display: 'grid', justifyItems: 'center', gap: 4, padding: '16px 14px', border: '1px dashed rgba(184, 243, 74,.24)', borderRadius: 12, background: 'rgba(17,19,27,.72)', textAlign: 'center' }}>
