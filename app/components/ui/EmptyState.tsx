...
export default function EmptyState({ title, description, action }: { title: string; description?: string; action?: ReactNode }) {
  return (
    <div style={{ display: 'grid', justifyItems: 'center', gap: 10, padding: '42px 24px', border: '1px dashed rgba(184, 243, 74,.24)', borderRadius: 'var(--radius-lg)', background: 'rgba(17,19,27,.72)', textAlign: 'center' }}>
      <span style={{ display: 'grid', placeItems: 'center', width: 46, height: 46, borderRadius: 'var(--radius-lg)', color: 'var(--primary)', background: 'rgba(184, 243, 74,.10)' }}>
