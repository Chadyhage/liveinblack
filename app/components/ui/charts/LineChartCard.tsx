    ...
    <div className={styles.root} style={{ height }}>
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 12, right: 8, left: 8, bottom: 0 }}>
          ...
          />
          <Area type="monotone" dataKey="value" stroke="var(--primary)" strokeWidth={3} fill="url(#agent-signups-area)" dot={false} activeDot={{ r: 5, fill: 'var(--primary)', stroke: '#1a1c15', strokeWidth: 3 }} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  )
