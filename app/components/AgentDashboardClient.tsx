        ...
        {loading || !stats ? (
          ...
          <>
            <section>
              ...
              <Card accent="rgba(184, 243, 74,0.30)" style={{ borderLeft: '3px solid rgba(184, 243, 74,0.6)', marginBottom: 10 }}>
            ...
            <section>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                {[
                  ...
                  <Card key={s.label} accent={s.alert ? '#e05aaa55' : undefined} style={{ padding: 16 }}>
