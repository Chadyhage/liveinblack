  ...
  return (
    <div
      ...
      style={{
        ...
        background: `radial-gradient(circle 900px at 6% 4%, rgba(184, 243, 74,.08), transparent 60%), radial-gradient(circle 820px at 96% 38%, rgba(124, 92, 255,.07), transparent 56%), #0a0a0d`,
