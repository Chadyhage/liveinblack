...
export default function GuestlistModal({ event, onClose }: GuestlistModalProps) {
  ...
  return (
    <Modal onClose={onClose} maxWidth={1120} ariaLabel="Liste des invités">
      ...
      {confirmRemove && (
        <Modal onClose={() => setConfirmRemove(null)} maxWidth={360} hideClose ariaLabel="Retirer un invité" contentStyle={{ padding: 22, borderRadius: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
