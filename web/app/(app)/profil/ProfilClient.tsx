    ...
    <main style={{ minHeight: '100vh', padding: '28px 16px 48px' }}>
      <div style={{ maxWidth: 480, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <MenuRow label="Événements intéressés" onClick={() => router.push('/profil/evenements-interesses')} />
          <MenuRow label="Organisateurs suivis" onClick={() => router.push('/profil/organisateurs-suivis')} />
